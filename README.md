...
When all that is done and stored in e.g. ``my_simulation.rb`` do ```$>ruby my_simulation.rb``` and sit back. It may look like <a href="http://jorisvanzundert.net/public/simsome/Brave New Epistemic World.mov">this</a>.
